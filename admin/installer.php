...
<div class="container form-signin">
            ...
            <legend>Classy CMS Installer : <br>Database Configuration</legend>
            <div class="control-group">
                <label class="control-label" for="dbHost">Database Host: </label>
                <div class="controls">
                	<input type="text" name="dbHost" class="input-block-level" id="dbHost" placeholder="localhost">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="dbName">Database Name: </label>
                <div class="controls">
                	<input type="text" name="dbName" class="input-block-level" id="dbName" placeholder="Database">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="dbUser">Username: </label>
                <div class="controls">
              	  <input type="text" name="dbUser" class="input-block-level" id="dbUser" placeholder="Username">
                </div>
            </div>
             <div class="control-group">
                <label class="control-label" for="dbPass">Password: </label>
                <div class="controls">
              	  <input type="password" name="dbPass" class="input-block-level" id="dbPass" placeholder="Password">
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
